package com.example.taskflow.ui.commonUI
...
private fun ProgressStatus(
    ...
    Text(modifier = modifier, text = buildAnnotatedString {
        val emphasisSpan =
            MaterialTheme.typography.titleSmall.copy(color = if (currentValue == maxValue) completedColor else progressIndicatorColor)
                .toSpanStyle()
        val defaultSpan =
